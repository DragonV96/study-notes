...
​	15.【不合格】说一下 Synchronized 和 Lock 的区别。
...
​	11.【模糊】新生代、老年代分别用的是什么垃圾回收算法？

答：新生代用的是标记复制算法，老年代用的是标记整理算法。



​	12.【盲区】针对 CMS 垃圾收集器，有哪些 JVM 相关的优化参数？

答：



​	13.【遗忘】可达性分析算法中，可以作为 GC Roots 的对象有哪些?
...
答：Spring 核心组件有三个 Bean、Context 和 Core：
...
​	6.【盲区】说一下 select poll 和 epoll 的区别。
