...
* [1 IO 流](#1-IO-流)
    * [1\.1 概念](#11-概念)
    * [1\.2 Java 的 IO](#12-Java-的-IO)
* [2 IO 模型](#2-IO-模型)
    * [2\.1 Socket](#21-Socket)
    * [2\.2 阻塞式 IO](#22-阻塞式-IO)
    * [2\.3 非阻塞式 IO](#23-非阻塞式-IO)
    * [2\.4 信号驱动式 IO](#24-信号驱动式-IO)
    * [2\.5 异步 IO](#25-异步-IO)
* [3 操作系统的 IO 复用机制](#3-操作系统的-IO-复用机制)
    * [3\.1 select](#31-select)
    * [3\.2 poll](#32-poll)
    * [3\.3 epoll](#33-epoll)
* [4 NIO 的优化](#4-NIO-的优化)
    * [4\.1 Selector](#41-Selector)
    * [4\.2 零拷贝](#42-零拷贝)
    * [4\.3 线程模型优化路线](#43-线程模型优化路线)
        * [4\.3\.1 NIO 组件](#431-NIO-组件)
        * [4\.3\.2 单线程 Reactor 线程模型](#432-单线程-Reactor-线程模型)
        * [4\.3\.3 多线程 Reactor 线程模型](#433-多线程-Reactor-线程模型)
        * [4\.3\.4 主从 Reactor 线程模型](#434-主从-Reactor-线程模型)
